...
## Repository-derived conclusion

A source repository can dogfood its product without storing source-repository state inside the product template by using a separate live instance whose configuration points to the shared templates and schemas.
